...
This have a menu of welcome when start and it show "C>" promt for type "e" and press enter and then, the COM file say "Saliendo de Command" or type "o" for list directories and see files. You must use the spacebar for go step by step and you can press "1" for a message of HELLO.COM file. Also, exist a second program for test the keyboard :).
