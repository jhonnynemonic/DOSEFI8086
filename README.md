...
EFIDOSBOX6-EXE-VRAM-EFI File for boot emulator 8086 in x86_64 and boot .EXE file and .COM file of DOS 16-bit type MZ Header embebed and start Video Representation in mode 8086 - 13h. File dosbox-LENOVOandTHEATEAM.efi sample with two screens, the change is key press when started on machine or emulator. Importante remember in computer if use SHELL EFI set "mode 80 25" for see the demostratio of emulation screen with 8086 cpu in UEFI computer.
