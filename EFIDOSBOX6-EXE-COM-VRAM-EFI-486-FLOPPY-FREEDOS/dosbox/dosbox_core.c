...
//
// INSTALAR VECTOR INT 0 (Divide Error)
//
mem_write16(0x00000, 0x0200); // IP = 0200h
mem_write16(0x00002, 0xF000); // CS = F000h

// Rutina INT 0 en F000:0200 → IRET
mem_write8(0xF0000 + 0x0200, 0xCF); // opcode IRET
