...
uint16_t get_ax(void) { return cpu.eax & 0xFFFF; }
uint16_t get_bx(void) { return cpu.ebx & 0xFFFF; }
uint16_t get_cx(void) { return cpu.ecx & 0xFFFF; }
uint16_t get_dx(void) { return cpu.edx & 0xFFFF; }
