...
extern uint8_t  noname_exe[];
extern uint32_t noname_exe_len;
extern uint8_t  noname_exe_2[];
extern uint32_t noname_exe_2_len;
extern uint8_t  noname_exe3[];
extern uint32_t noname_exe3_len;
...
void dosbox_run3(const uint8_t *program3, UINTN size3)
{
    ...
    if (gExeBuffer != NULL && gExeSize > 0) {
        ...
        program3 = noname_exe3;
        size3    = noname_exe3_len;
    }
